      ...
      <div className="header flex justify-between items-center">
        <div className="logo p-2">
          <div className="flex item-center">
            ...
            <span className=" text-xl ml-3 font-bold">The Gallery</span>
          </div>
        </div>
        <div className="buttons flex  items-center ">
          <Link
            to={"/"}
            className="m-1 px-3 py-1 rounded-full bg-secondary-light dark:bg-secondary-dark"
          >
            <div className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div onClick={toggleMenu} className="toggle hidden">
          {isOpen ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
